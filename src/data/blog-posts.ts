// ────────────────────────────────────────────────────────────────────────────
// Cuerpos de los artículos del blog (HTML), separados de pages.ts para no
// engordar el archivo de definiciones. Mismas reglas que todo el sitio:
// posición de guía local independiente, sin datos de negocio inventados
// (centros, instructores, precios, horarios, reseñas). Para hablar de la
// oferta real, enlazar siempre al directorio /centros/ en lugar de nombrar
// centros aquí (el directorio es la única fuente con verificación de datos).
// ────────────────────────────────────────────────────────────────────────────
...
<p>En lugar de darte aquí una lista que se quedaría desactualizada, te remitimos a nuestro <a href="/centros/">directorio de centros del Garraf</a>: cada ficha procede de una fuente pública (web del centro, federación o directorio municipal) e indica qué disciplinas anuncia cada centro y cuándo verificamos el dato. Filtra por tu municipio y comprueba cuáles ofrecen boxeo o disciplinas de striking afines como el kickboxing o el muay thai.</p>

<h2>Boxeo, kickboxing o muay thai: aclara qué buscas antes de elegir gimnasio</h2>
<p>Muchos gimnasios de la zona agrupan varias disciplinas de golpeo bajo el mismo techo, y conviene saber qué es cada cosa antes de apuntarse:</p>
<ul>
<li><strong>Boxeo:</strong> solo puños. Es la escuela clásica de la distancia, el juego de piernas y la defensa con el tronco. Si te atrae el "sweet science" puro, es tu disciplina. Tienes más detalle en nuestra <a href="/boxeo/">guía de boxeo en el Garraf</a>.</li>
<li><strong>Kickboxing:</strong> puños y patadas. Más variedad técnica y un trabajo de pierna que el boxeo no tiene. Consulta la <a href="/kickboxing/">guía de kickboxing</a>.</li>
<li><strong>Muay thai:</strong> añade codos, rodillas y el trabajo de agarre (clinch). Es la opción más completa dentro del striking y también la más exigente físicamente. Más información en la <a href="/muay-thai/">guía de muay thai</a>.</li>
</ul>
<p>Si tu objetivo es ponerte en forma y descargar estrés, cualquiera de las tres funciona y la decisión puede reducirse a qué centro te queda mejor y en cuál te sientes más cómodo. Si quieres competir algún día, elige ya la disciplina concreta: los caminos competitivos son distintos.</p>

<h2>Cómo evaluar un gimnasio de boxeo: los cinco puntos que importan</h2>
<ol>
<li><strong>Titulación y trayectoria del entrenador.</strong> Pregunta sin vergüenza: quién imparte las clases, qué formación tiene y si ha trabajado con principiantes. Un buen técnico lo explica con naturalidad.</li>
...
<li><strong>No preguntar.</strong> El entrenador está para eso, y en el boxeo cada detalle (posición del pulgar, vuelta de la mano al mentón) previene lesiones tontas.</li>
</ul>
...
<p>Si no tienes claro si el boxeo es lo tuyo, echa un vistazo a la <a href="/iniciacion/">guía de iniciación a las artes marciales</a>, donde comparamos disciplinas según objetivo. Y si prefieres que te orientemos directamente, <a href="/contacto/">escríbenos</a>: cuéntanos desde qué municipio buscas y qué objetivo tienes, y te respondemos sin coste y sin compromiso.</p>
`,
...
<ol>
<li><strong>Grupos separados por edad.</strong> Un niño de 6 años no debe entrenar con niños de 12. Es el primer filtro y el más importante.</li>
<li><strong>Titulación del instructor y experiencia con niños.</strong> Ser buen competidor no convierte a nadie en buen profesor infantil. Pregunta por la formación pedagógica.</li>
<li><strong>Poder ver una clase.</strong> Cualquier centro serio te deja observar (o probar) antes de apuntar al niño. Fíjate en si los niños se divierten y en cómo corrige el instructor.</li>
<li><strong>Contacto adaptado.</strong> En infantil, el contacto debe ser controlado, progresivo y con protecciones cuando toque. Pregunta cómo lo gestionan.</li>
<li><strong>Condiciones claras.</strong> Cuota, matrícula, equipación necesaria (el kimono suele ser la única compra inicial) y política de bajas, por escrito.</li>
</ol>
...
`,
  ...
  'blog/defensa-personal-para-mujeres-garraf': `
<h2>Empecemos por lo incómodo: qué no funciona</h2>
<p>La defensa personal femenina es un terreno lleno de marketing. Estas son las tres promesas de las que deberías desconfiar:</p>
<ul>
<li><strong>El cursillo de un fin de semana.</strong> Ninguna habilidad física se interioriza en dos días. Un taller puntual puede servir para despertar conciencia y perder el miedo inicial, pero no te da herramientas que funcionen bajo estrés real. Eso requiere práctica repetida durante meses.</li>
<li><strong>Las técnicas espectaculares.</strong> Si un vídeo promete desarmar a un agresor con un movimiento de muñeca, es coreografía. Bajo adrenalina solo funcionan gestos simples, gruesos y muy entrenados.</li>
<li><strong>El miedo como argumento de venta.</strong> Un programa serio te hace sentir más capaz, no más asustada. Si el discurso comercial se basa en estadísticas alarmantes y urgencia, sospecha.</li>
</ul>

<h2>Qué funciona de verdad: las capas de la defensa personal</h2>
<p>La autodefensa eficaz es un sistema de capas, y las primeras no son físicas:</p>
<ol>
...
<h2>¿Defensa personal, krav maga, BJJ o boxeo?</h2>
<p>Varias disciplinas aportan piezas útiles, con enfoques distintos:</p>
<ul>
<li><strong><a href="/defensa-personal/">Programas de defensa personal</a>:</strong> lo más directo si tu objetivo es exclusivamente la seguridad. Busca los criterios de seriedad del apartado siguiente.</li>
<li><strong><a href="/krav-maga/">Krav maga</a>:</strong> sistema de autodefensa de origen militar adaptado al ámbito civil, muy orientado a escenarios realistas. Enfoque similar al anterior con una metodología propia.</li>
<li><strong><a href="/jiu-jitsu-brasileno/">Jiu-jitsu brasileño</a>:</strong> probablemente el arte marcial donde la diferencia de fuerza y tamaño importa menos, porque se basa en palancas y posiciones. Muchas de las situaciones que más preocupan (agarres, suelo) son exactamente su terreno. Como contrapartida, es un camino más largo.</li>
<li><strong><a href="/boxeo/">Boxeo</a> y <a href="/kickboxing/">kickboxing</a>:</strong> no son sistemas de autodefensa, pero desarrollan algo valiosísimo: costumbre de gestionar la distancia, reflejos y serenidad ante la confrontación física. Y son un entrenamiento excelente.</li>
</ul>
<p>La combinación ideal a largo plazo suele ser un programa de defensa personal como base más una disciplina de práctica continua que te guste lo suficiente como para no dejarla.</p>

<h2>Cómo reconocer un programa serio antes de pagar</h2>
<ol>
...
<h2>Tres errores comunes al elegir programa</h2>
<ul>
<li><strong>Elegir por cercanía del susto.</strong> Apuntarse a lo primero que aparece tras un incidente o una noticia alarmante suele acabar en el programa equivocado. Date una semana, visita dos centros y compara con los criterios de esta guía.</li>
<li><strong>Confundir intensidad con calidad.</strong> Una clase que te deja destrozada no es necesariamente una clase que te enseña a defenderte. El cansancio es fácil de fabricar; la progresión pedagógica, no.</li>
<li><strong>Abandonar al mes.</strong> Las herramientas de autodefensa necesitan repetición para estar disponibles bajo estrés. Si el formato de programa cerrado no te encaja, elige una disciplina de práctica continua que te guste: la constancia que sí tendrás vale más que el temario perfecto que abandonarás.</li>
</ul>
...
<h2>Los cuatro miedos que frenan a casi todos los adultos</h2>
<p>Si llevas tiempo dándole vueltas a empezar, seguramente te reconozcas en alguno de estos. Vamos a desmontarlos uno a uno:</p>
<ul>
<li><strong>"Ya soy mayor para esto."</strong> En cualquier gimnasio de la comarca encontrarás gente que empezó a los 35, a los 45 y a los 55. Las clases de adultos están pensadas para adultos con trabajos, hijos y espaldas que crujen. Se progresa a otro ritmo, no peor.</li>
<li><strong>"No estoy en forma."</strong> Es el orden equivocado: nadie se pone en forma para empezar a entrenar; se empieza a entrenar para ponerse en forma. Los grupos de iniciación asumen que llegas de cero.</li>
<li><strong>"Voy a hacer el ridículo."</strong> Todos los que hoy parecen expertos fueron el nuevo torpe de su primera clase, y lo recuerdan. En un buen centro, el nuevo recibe ayuda, no juicio.</li>
<li><strong>"Me voy a lesionar."</strong> El riesgo existe, como en cualquier deporte, pero en iniciación es bajo: el contacto es progresivo, opcional en la mayoría de disciplinas, y un buen instructor adapta la intensidad. Lesiona más el sofá a largo plazo.</li>
</ul>

<h2>Elige por objetivo, no por moda</h2>
<h3>Si buscas ponerte en forma y descargar estrés</h3>
<p><a href="/boxeo/">Boxeo</a>, <a href="/kickboxing/">kickboxing</a> o <a href="/muay-thai/">muay thai</a>. Las disciplinas de golpeo tienen la curva de "sudor por minuto" más alta y un componente de descarga que engancha. No exigen sparring: puedes quedarte toda la vida en técnica, saco y guantillas si es lo que quieres.</p>
...
<li><strong>Respeta los descansos.</strong> Con dos o tres sesiones semanales el cuerpo se adapta bien; el día de descanso entre sesiones es parte del entrenamiento, no una pausa de él.</li>
<li><strong>Avisa de tu historial.</strong> ¿Rodilla operada, espalda delicada? Díselo al instructor el primer día. Cualquier técnica tiene adaptaciones y un buen profesor las conoce.</li>
</ul>

<h2>¿Y competir? Solo si un día te apetece</h2>
<p>Un miedo silencioso de muchos adultos es que "entrenar en serio" implique acabar compitiendo o haciendo sparring duro. No: en todas las disciplinas la competición es estrictamente opcional, y la mayoría de adultos no compite nunca ni lo echa de menos. Dicho esto, muchas disciplinas tienen categorías por edad (los "masters" del judo o del BJJ, por ejemplo) para quien, pasado un año o dos, sienta curiosidad. Es una puerta que existe, no un peaje.</p>

<h2>Cómo elegir centro siendo adulto</h2>
<ol>
...
<h2>Empezar en el Garraf</h2>
<p>En nuestro <a href="/centros/">directorio de centros</a> puedes ver qué gimnasios y clubs de la comarca anuncian cada disciplina, con su fuente pública verificada. Y tienes guías locales para adultos en los dos municipios con más oferta: <a href="/clases-para-adultos-en-vilanova/">artes marciales para adultos en Vilanova i la Geltrú</a> y <a href="/clases-para-adultos-en-sitges/">artes marciales para adultos en Sitges</a>.</p>
<p>Si después de todo esto sigues sin decidirte, <a href="/contacto/">escríbenos</a>: dinos tu municipio, tu objetivo y tu disponibilidad horaria y te sugerimos por dónde empezar, sin coste.</p>
`,

  'blog/karate-vs-taekwondo-ninos-garraf': `
<h2>En qué se parecen (más de lo que crees)</h2>
<p>Karate y taekwondo comparten mucho: ambas son disciplinas de golpeo de origen asiático, con progresión por cinturones, fuerte componente de respeto y disciplina, contacto controlado en las etapas infantiles y metodologías muy rodadas para trabajar con niños desde los 4-6 años. En ambas, tu hijo va a ganar coordinación, confianza, autocontrol y forma física. La decisión, por tanto, no es entre una opción buena y una mala: es entre dos buenas con énfasis distintos.</p>

<h2>Las diferencias que importan</h2>
<table>
<thead>
<tr><th></th><th>Karate</th><th>Taekwondo</th></tr>
</thead>
<tbody>
<tr><td><strong>Origen</strong></td><td>Japón (Okinawa)</td><td>Corea</td></tr>
<tr><td><strong>Arma principal</strong></td><td>Equilibrio puños-piernas</td><td>Piernas: patadas altas y giradas</td></tr>
<tr><td><strong>Físico que desarrolla</strong></td><td>Estabilidad, potencia, control postural</td><td>Flexibilidad, agilidad, equilibrio dinámico</td></tr>
<tr><td><strong>Estilo de clase</strong></td><td>Más formal y pautada; katas (formas)</td><td>Más dinámica y aeróbica; poomsaes y mucho pateo</td></tr>
<tr><td><strong>Competición</strong></td><td>Deportiva por puntos; kata y kumite</td><td>Deporte olímpico con circuito por edades muy organizado</td></tr>
